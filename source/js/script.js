(function ($) {
    ...
    const roles = ["designer", "developer", "student", "creative"];
    let currentIndex = 0; 
    let charIndex = 0; 
    let isDeleting = false;

    // Target the element with ID "role"
    ...
    function typeEffect() {
        ...
        roleElement.text(currentRole.substring(0, charIndex));

        // Determine the speed of typing and deleting
